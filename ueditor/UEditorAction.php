...
class UEditorAction extends Action
{
    ...
    public function init()
    {
        ...
        //添加图片默认root路径；
        /*$_config['imageRoot'] = Yii::getAlias('@static');
        $_config['scrawlRoot'] = Yii::getAlias('@static');
        $_config['videoRoot'] = Yii::getAlias('@static');
        $_config['fileRoot'] = Yii::getAlias('@static');*/
        //$_config['imageUrlPrefix'] = Yii::$app->request->hostInfo;//给上传的文件添加域名前缀
        //load config file
